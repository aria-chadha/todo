    ...
    <div>
        <v-container class="d-flex align-center justify-center" style="height: 900px">
            ...
            >
                ...
                <h2 class="fw-bold my-6 text-uppercase">Register</h2>
                ...
                <v-btn
                    v-if="password.length != 0 && email.length != 0"
                    @click="onSubmit"
                    class="px-5"
                    >Register</v-btn
                >
                <v-btn v-else disabled class="px-5">Register</v-btn>
                <div class="pt-5">
                    <p class="card-footer text-center">
                        Have an account?
                        <a href="/#/login" color="white">Log in</a>
                    </p>
                </div>
            </v-card>
        </v-container>
